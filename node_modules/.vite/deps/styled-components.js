...
function We(e, t2, n2, o, s = []) {
  ...
  if ("function" === r2) {
    if (Ge(e)) return false, s;
    if (De(e) && t2) {
      const r3 = e(t2);
      return true, We(r3, t2, n2, o, s);
    }
    return s.push(e), s;
  }
  if (Array.isArray(e)) {
  ...
  return ce(e) ? (s.push(`.${e.styledComponentId}`), s) : ke(e) ? (n2 ? (e.inject(n2, o), s.push(e.getName(o))) : s.push(e), s) : Ge(e) ? (false, s) : ue(e) ? e.toString !== Object.prototype.toString ? (s.push(e.toString()), s) : (ze(e, s), s) : (s.push(e.toString()), s);
}
var Le = F(u);
var Be = class {
  constructor(e, t2, n2) {
    ...
    let o = this.baseStyle ? this.baseStyle.generateAndInjectStyles(e, t2, n2) : "";
    {
      ...
      for (let o2 = 0; o2 < this.rules.length; o2++) {
        ...
        if ("string" == typeof r2) s += r2;
          ...
          const o3 = r2(e);
          "string" == typeof o3 ? s += o3 : null != o3 && false !== o3 && (true, s += le(We(o3, e, t2, n2)));
...
function ut(o, s, r2) {
    ...
    return (function(o3, s3, r3) {
      ...
      let y3, g2;
      {
        ...
        if (null !== n2 && n2[1] === m3 && n2[2] === p3.styleSheet && n2[3] === p3.stylis && n2[7] === c3 && (function(e2, t2, n3) {
          ...
          e.current = [s3, m3, p3.styleSheet, p3.stylis, n3, y3, g2, c3];
        }
      }
      ...
      let b2 = ae(l3, u3);
      return g2 && (b2 += " " + g2), y3.className && (b2 += " " + y3.className), S2[L(v2) && v2.includes("-") ? "class" : "className"] = b2, r3 && (S2.ref = r3), (0, import_react.createElement)(v2, S2);
    })(g, o2, s2);
  }
  y2.displayName = h2;
  let g = import_react.default.forwardRef(y2);
  return g.attrs = p2, g.componentStyle = m2, g.displayName = h2, g.shouldForwardProp = f2, g.foldedComponentIds = i2 ? ae(c2.foldedComponentIds, c2.styledComponentId) : "", g.styledComponentId = d2, g.target = i2 ? c2.target : o, Object.defineProperty(g, "defaultProps", { get() {
  ...
  } }), false, de(g, () => `.${g.styledComponentId}`), a2 && se(g, o, { attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true }), g;
}
...
function St(e, ...n2) {
  ...
  const i2 = (e2) => {
    ...
    false, false, n3.styleSheet.server && c2(a2, e2, n3.styleSheet, i3, n3.stylis);
    {
...
function At(e) {
  const n2 = import_react.default.forwardRef((n3, o) => {
    ...
    return false, import_react.default.createElement(e, Object.assign(Object.assign({}, n3), { theme: s, ref: o }));
  });
